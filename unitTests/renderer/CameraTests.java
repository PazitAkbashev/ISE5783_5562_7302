...
class CameraTests {
    ...
    void testConstructRay() {
        ...
        // EP01: 4X4 Inside (1,1)
        assertEquals(new Ray(ZERO_POINT,
                        new Vector(1, -1, -10)),
                camera
                        .setVPSize(8, 8)
